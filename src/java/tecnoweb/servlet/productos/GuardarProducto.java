...
public class GuardarProducto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usuario ==null) { // Se ha llamado al servlet sin haberse autenticado
            ...
            int idSubcat = Integer.parseInt(subcategoriaString);
            ...
            if (nombre.isEmpty() || descripcion.isEmpty() || precio.isEmpty() || palabrasClave.isEmpty()) {
                ...
                SubcategoriaDTO subcategoriaAux = this.subcategoriasService.find(idSubcat);
                ...
                this.productosService.createOrUpdate(productoId, nombre, descripcion, precio, url, idSubcat, palabrasClave, usuario.getIdUsuario());
                
                //Actualizar categorias (para que se actualicen los numeros de productos de cada subcateogira)
