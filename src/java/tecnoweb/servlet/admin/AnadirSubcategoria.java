...
public class AnadirSubcategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(str == null){
            ...
            subcate = this.subcategoriaFacade.find(new Integer(str));
        }
        ...
        Categoria c;
        c = this.categoriaFacade.find(idesito);
        subcate.setIdCategoria(c);
        src = request.getParameter("nombre");
        subcate.setNombreSubcategoria(src);
        
        if(esNuevo){
            this.subcategoriaFacade.create(subcate);
            //Actualizar categoria
            c.getSubcategoriaList().add(subcate);
            this.categoriaFacade.edit(c);
        }else{
            this.subcategoriaFacade.edit(subcate);
        }
