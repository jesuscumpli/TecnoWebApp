 ...
 * @author haylo
 */
@WebServlet(name = "ListadoCategoriasAdmin", urlPatterns = {"/ListadoCategoriasAdmin"})
public class ListadoCategoriasAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<CategoriaDTO> lista = categoriasService.findAll();
