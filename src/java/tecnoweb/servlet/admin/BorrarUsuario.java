...
public class BorrarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //BORRA TU CUENTA CON LA QUE INICIAS SESION
        UsuarioDTO usuario;
        ...
        if (str == null) {
            ...
            usuario = this.usuariosService.findByIdDTO(new Integer(str));
            if(usuario==null){
                LOG.log(Level.SEVERE, "No se ha encontrado el usuario a borrar");
                response.sendRedirect("ListadoUsuarioAdmin");
            }else {
        ...
        List<Usuario> lista = (List)sesion.getAttribute("lista");
        String str = request.getParameter("id");
        lista.remove(Integer.parseInt(str));
        response.sendRedirect("ListadoUsuarioAdmin.jsp");
        */
    }
