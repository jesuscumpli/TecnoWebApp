 ...
 * @author Jesús
 */
@WebServlet(name = "LimpiarPalabrasClaves", urlPatterns = {"/LimpiarPalabrasClaves"})
public class LimpiarPalabrasClaves extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        status = "Se han eliminado "+num+" palabras claves sin usar de la base de datos";
