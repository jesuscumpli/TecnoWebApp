...
public class ProductosService {
    ...
    public void createOrUpdate (String productoId, String nombre, String descripcion, String precio, 
                                String url, String subcategoriaString, String palabrasClave, Integer usuario) {
        ...
        Subcategoria subcategoria = this.subcategoriaFacade.findByName(subcategoriaString);
