...
<html>
    <head>
     ...
     <%
        ...
        CategoriaMenuDTO categoriaSeleccionada = (CategoriaMenuDTO) request.getAttribute("categoria");
        ...
        List<CategoriaMenuDTO> listaCategorias = (List<CategoriaMenuDTO>) session.getAttribute("categorias");
     %>
    <body>                       
 
        <div id="contenedorCentral">
        <div id="evaluacion" class="border border-primary rounded container-fluid">
        <form method="post" class="was-validated" action="GuardarProducto" accept-charset="UTF-8">
            ...
            <div class="form-row">
                 ...
                 <div class="col">
                    ...
                    <input class="form-control" type = "number" step="0.01" name = "precio" required value="<%=precio%>"/> <br/>
            ...
            <div class="form-inline">
                ...
                <div class="form-group">
                  ...
                  <select id="inputCategoria" name="categoria" class="custom-select">
                    <%
                        for (CategoriaMenuDTO c: listaCategorias) {
                            String seleccionado = "";
                ...
                <div class="form-group">
                  ...
                  <select id="inputSubcategoria" name="subcategoria" class="custom-select">
                     <%
                        for (SubcategoriaDTO sc: categoriaSeleccionada.getSubcategoriaList()) {
                            String seleccionado = "";
                                if (idSubcategoria != -1 && idSubcategoria == sc.getIdSubcategoria()) {
                                     seleccionado = "selected";       
                                }
                    %>
                    <option <%=seleccionado%> value="<%= sc.getIdSubcategoria()%>"><%= sc.getNombreSubcategoria() %></option>
                    <%
                        }
                    %>
                  </select>
