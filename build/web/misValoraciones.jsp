...
<%@page import="tecnoweb.dto.ProductoDTO"%>
...
<html>
    ...
    <%
        ...
        List<ValoracionDTO> misVals = (List<ValoracionDTO>) session.getAttribute("misValoraciones");
    %>
    <body>
        <!-- NAVBAR INICIO -->
        ...
        <%
            ...
            Filtro.ordenarValoracionesPorFechaDTO(misVals);
            for(ValoracionDTO v: misVals){
                ProductoMenuDTO p = v.getProducto();
