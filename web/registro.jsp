...
<html>
    ...
    <body>
            ...
            <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto mx-2">
                    <li class="nav-item active mx-2">
                        <a class="nav-link text-white" href="login.jsp">Inicio</a>
                    </li>
                    <li class="nav-item mx-2">
                        <a class="nav-link text-white h5 font-weight-bold" href="#" >Registro</a>
                    </li>
                </ul>
            </div>
         </nav>
        ...
        <div id="panel" class="border border-primary rounded">
            <h2>Registro</h2>   
            <small class="text-white ml-2">*Campos obligatorios</small>
            <small class="text-dark font-italic font-weight-bold ml-5"> <%=status%> </small>
