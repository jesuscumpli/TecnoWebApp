<%-- 
    Document   : edicionUsuarioAdmin
    Created on : 30-mar-2020, 18:44:11
    Author     : haylo
--%>
...
<html>
    <%
        ...
        admin = (UsuarioDTO)session.getAttribute("usuario");
        if (admin == null || !admin.getIsAdmin()) {
            response.sendRedirect("login.jsp");  
            return;
        }
        
        UsuarioDTO usr = (UsuarioDTO) request.getAttribute("usuario");
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-dark" id="navbarInicio">
            ...
            <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
                ...
                <div class="nav-item float-right float-sm-left pl-0">
                    <img class="d-inline-block align-middle" id="imagenPerfilNavBar" src="<%=admin.getFotoUsuario()%>" alt="Italian Trulli"/>
        ...
        <div class="row">
            ...
            <div class="container panel-primary" id="centro">
                ...
                <div class="panel-body" id="contenido">
                    ...
                    <form id="buttonAceptar" method="post" action="EdicionUsuarioAdmin?idUsuario=<%= usr.getIdUsuario() %>" name="aceptarEditar" accept-charset="UTF-8">
                        <!-- PRIMER BLOQUE -->
                        <div class="row">
                            <!-- IMAGEN -->
                            <div id="imagen">
                        ...
                        <div class="row" id="segundoBloque">
                            ...
                            <div id="segundoDcha">
                                ...
                                <div id="buttonCancelar">
                                    <a href="./ListadoUsuarioAdmin" class="btn btn-primary btn-sm btn-dark float-right" value="Cancelar Perfil">Cancelar Cambios</a>
                                    </br>
                                </div>
                            </div>
                        </div> <!-- Segundo Bloque -->
